...
artist.myClass = BA.getDeviceClass ("b4a.example.artist");
artwork.myClass = BA.getDeviceClass ("b4a.example.artwork");
artistsservice.myClass = BA.getDeviceClass ("b4a.example.artistsservice");
artworksservice.myClass = BA.getDeviceClass ("b4a.example.artworksservice");
artistpages.myClass = BA.getDeviceClass ("b4a.example.artistpages");
artworkpages.myClass = BA.getDeviceClass ("b4a.example.artworkpages");
